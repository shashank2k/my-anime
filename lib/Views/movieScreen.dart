                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              onPressed: () {
                                ...
                                movieController.fetchMovies(searchText).then((
                                    value) {
                                  movieController.movies.value = value;
                                });
                              },
                ...
                Padding(padding: const EdgeInsets.symmetric(horizontal: 25),
                  child: SizedBox(
                      ...
                      child: TextField(
                          ...
                          decoration: InputDecoration(
                            label: Text(
                              'Search', style: myTextTheme.bodyMedium,),
                            border: const OutlineInputBorder(
                              borderRadius: BorderRadius.all(
                                  Radius.circular(10.0)),
                            ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Obx(() => DropdownButton<int>(
                      value: movieController.selectedServer.value, // Initially set to the first server
                      onChanged: (int? newIndex) {
                        // Handle dropdown value change
                        print('Selected Server: ${Common.movieUrls[newIndex!]}');
                        movieController.selectedServer.value = newIndex;
                      },
                      items: Common.movieUrls.asMap().entries.map<DropdownMenuItem<int>>((entry) {
                        return DropdownMenuItem<int>(
                          value: entry.key,
                          child: Text('Server ${entry.key + 1}', style: myTextTheme.bodyMedium),
                        );
                      }).toList(),
                    )),
                  ...
                  children: [
                    ...
                    GridView.builder(
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount:
                        Get.width > 800 ? 3 : 2, // Set the number of columns
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            print(
                                'anime titile ${movieController.movies[index]
                                    .animeTitle}');
                            Get.to(() =>
                                // AnimeDetailsScreen(
                            ...
                            MovieDetailsScreen(
                              animeKey: movieController.movies[index].animeId,
                              title: movieController.movies[index]
                                  .animeTitle,
                            ));
                          },
                          child: Column(
